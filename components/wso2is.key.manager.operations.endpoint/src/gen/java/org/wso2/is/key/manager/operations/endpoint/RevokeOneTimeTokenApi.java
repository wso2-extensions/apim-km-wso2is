...
RevokeOneTimeTokenApiService delegate = new RevokeOneTimeTokenApiServiceImpl();
    ...
    public Response revokeOneTimeTokenPost(@ApiParam(value = "Unique identifier of the OTT." ,required=true) RevokeTokenInfoDTO revokeTokenInfo){
        return delegate.revokeOneTimeTokenPost(revokeTokenInfo, securityContext);
    }
}
