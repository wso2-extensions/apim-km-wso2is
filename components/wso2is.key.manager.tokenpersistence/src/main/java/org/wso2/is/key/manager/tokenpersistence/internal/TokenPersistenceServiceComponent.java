...
import org.wso2.is.key.manager.tokenpersistence.processor.InMemoryAccessTokenProvider;
    ...
    protected void activate(ComponentContext cxt) {
        ...
        try {
            ...
            if (!enable) {
                ...
                cxt.getBundleContext().registerService(AccessTokenProvider.class,
                        new InMemoryAccessTokenProvider(), null);
            }
