...
public class SQLQueries {
    ...
    public static final String IS_INVALID_LEGACY_TOKEN = "SELECT 1 FROM IDN_OAUTH2_ACCESS_TOKEN WHERE "
    ...
    public static final String IS_INVALID_TOKEN = "SELECT 1 FROM IDN_INVALID_TOKENS WHERE TOKEN_IDENTIFIER = ? AND "
            + "CONSUMER_KEY = ? ";
    public static final String INSERT_INVALID_TOKEN = "INSERT INTO IDN_INVALID_TOKENS (UUID, SIGNATURE, CONSUMER_KEY, "
