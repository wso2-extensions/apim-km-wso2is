...
import org.wso2.is.tenant.management.APIMTenantSyncListener;
...
public class TenantManagementServiceComponent {
    ...
    protected void activate(ComponentContext componentContext) throws Exception {
        ...
        serviceRegistration =
                bundleContext.registerService(TenantMgtListener.class, new APIMTenantSyncListener(), null);
    }
    ...
    protected void setClaimMetadataManagementService(ClaimMetadataManagementService claimMetadataManagementService) {
        ServiceReferenceHolder.getInstance().setClaimMetadataManagementService(claimMetadataManagementService);
    }

    protected void unsetClaimMetadataManagementService(ClaimMetadataManagementService claimMetadataManagementService) {
        ServiceReferenceHolder.getInstance().setClaimMetadataManagementService(null);
    }
