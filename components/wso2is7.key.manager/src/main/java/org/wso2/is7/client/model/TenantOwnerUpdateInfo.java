 ...
 */
public class TenantOwnerUpdateInfo {
    ...
    public TenantOwnerUpdateInfo(String email, String password, String firstname, String lastname,
                                 List<TenantAdditionalClaims> additionalClaims) {
        this.email = email;
        this.password = password;
        this.firstname = firstname;
        this.lastname = lastname;
