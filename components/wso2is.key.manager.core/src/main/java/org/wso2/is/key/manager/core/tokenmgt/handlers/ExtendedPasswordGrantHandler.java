...
/**
 * Extended grant handler for password
 */
public class ExtendedPasswordGrantHandler extends PasswordGrantHandler {
    ...
    @Override public boolean validateGrant(OAuthTokenReqMessageContext tokReqMsgCtx) throws IdentityOAuth2Exception {
    ...
    private Claim[] getUserClaimValues(String authorizedUser, UserStoreManager userStoreManager)
        ...
        if (userClaims != null) {
            ...
            userClaims = userStoreManager.getUserClaimValues(authorizedUser, null);
    ...
    private void parseLoginConfig(OMElement oauthConfigElem) {
        ...
        if (loginConfigElem != null) {
            ...
            userIdConf.put(CLAIM_URI,
                    userIdConfigElem.getFirstChildWithName(getQNameWithIdentityNS(CLAIM_URI)).getText());
