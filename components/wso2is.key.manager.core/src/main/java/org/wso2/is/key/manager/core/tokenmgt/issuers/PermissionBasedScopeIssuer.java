...
public class PermissionBasedScopeIssuer extends AbstractScopesIssuer {
     ...
     */
    @Override public List<String> getScopes(OAuthTokenReqMessageContext tokReqMsgCtx) {
        ...
        if (appScopes != null) {
            ...
            authorizedScopes = getAuthorizedScopes(authenticatedUser, requestedScopes, appScopes);
        }
     ...
     * @return authorized scopes list
     */
    @Override public List<String> getScopes(OAuthCallback scopeValidationCallback) {
            ...
            for (String scope : reqScopeList) {
                ...
                if (appPermissions != null && appPermissions.length() != 0) {
                    List<String> permissions = new ArrayList<>(
                            Arrays.asList(appPermissions.replaceAll(" ", "").split(",")));
