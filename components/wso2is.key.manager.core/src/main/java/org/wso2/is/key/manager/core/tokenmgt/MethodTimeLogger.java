  ...
  /*  private static final Log log = LogFactory.getLog("correlation");
    ...
    *//**
    ...
    public static boolean pointCutAll() {
        if (!isLogAllSet) {
            String config = System.getProperty(ResourceConstants.LOG_ALL_METHODS);
    ...
    *//**
    ...
    public static boolean isConfigEnabled() {
        if (!isSet) {
            String config = System.getProperty(ResourceConstants.ENABLE_CORRELATION_LOGS);
            if (StringUtils.isNotEmpty(config)) {
    ...
    *//**
    ...
    public Object log(ProceedingJoinPoint point) throws Throwable {
        ...
        if (messageContext != null) {
            ...
            if (headers != null) {
                String correlationId = (String) headers.get(ResourceConstants.AM_ACTIVITY_ID);
                if (correlationId != null) {
                    MDC.put(ResourceConstants.CORRELATION_ID, correlationId);
                }
            }
        }
